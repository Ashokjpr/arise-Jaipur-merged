    ...
    <header className="sticky top-0 z-50 shadow-sm bg-white/90 backdrop-blur relative ">
      ...
      <nav className="relative bg-white/20 max-w-7xl mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* Right Section */}
          <div className="flex items-center gap-2">
            <Link href="/register" className="hidden md:block px-4 py-2 bg-blue-700 text-white rounded hover:bg-blue-800 transition"
            >
              Register
            </Link>
            {/* Mobile Toggle */}
      ...
      >
        ...
        <div className="bg-white/90 flex flex-col gap-2 p-4 font-medium h-screen overflow-y-auto">
          ...
          <Link href="/register" onClick={() => { setOpen(false); setMobileCoursesOpen(false); }} className="mt-4 px-4 py-2 bg-blue-700 text-white rounded-full text-center hover:bg-blue-800 transition"
          >
            Register
          </Link>
        </div>
