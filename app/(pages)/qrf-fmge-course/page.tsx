...
import { qrfFmgeCourse } from "../_data/cources/CourcesData";
      ...
      <main className="w-full overflow-hidden pb-24">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {qrfFmgeCourse.hero.title}
          </h1>

          <Link
            href={qrfFmgeCourse.hero.cta.link}
        ...
        >
          <h2 className="text-3xl font-bold mb-4">
            {qrfFmgeCourse.courseDetails.heading}
          </h2>

          <p className="text-gray-700 leading-relaxed mb-8">
            {qrfFmgeCourse.courseDetails.description}
          </p>

          {/* HIGHLIGHTS */}
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {qrfFmgeCourse.highlights.map((item, index) => (
              <li
                key={index}
