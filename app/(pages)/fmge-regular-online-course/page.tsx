...
import { fmgeRegularOnlineCourse } from "../_data/cources/CourcesData";
      ...
      <main className="w-full overflow-hidden pb-24 bg-white text-gray-600">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            {fmgeRegularOnlineCourse.hero.title}
          </h1>

          <Link
            href={fmgeRegularOnlineCourse.hero.cta.link}
            ...
            data-aos-delay="200"
          >
            {fmgeRegularOnlineCourse.hero.cta.label} →
          </Link>
        </section>
        ...
        >
          <h2 className="text-3xl font-bold mb-4">
            {fmgeRegularOnlineCourse.courseDetails.heading}
          </h2>

          <p className="text-gray-700 leading-relaxed mb-8">
            {fmgeRegularOnlineCourse.courseDetails.description}
          </p>

          {/* HIGHLIGHTS */}
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {fmgeRegularOnlineCourse.highlights.map((item, index) => (
              <li
                key={index}
