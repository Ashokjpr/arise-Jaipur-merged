  ...
  return (
    <section className="w-full bg-gradient-to-b from-blue-50 to-white py-5"  >
      ...
      <div className="max-w-4xl w-full bg-blue-900 text-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        {/* RIGHT QR SECTION */}
        <div className="bg-blue-100 text-blue-900 flex flex-col items-center justify-center md:w-80">
          ...
          <div className="relative w-40 h-40 md:w-60 md:h-60">
            <Image
              src="/images/jaipur-branch-qr.png"
              alt="Scan QR Code"
              fill
              className="object-contain"
            />
          ...
          {/* <p className="font-semibold -rotate-90 hidden md:block absolute right-4">
            Scan the code
          </p> */}
